...
export const PROYECTOS_GANTT: ProyectoGantt[] = [
  ...
  },
  {
    ...
    mw: 5,
    fases: [
      { fase: "Desarrollo", start: "2026-01", end: "2027-01", color: PHASE_COLORS.Desarrollo },
      { fase: "Permisos", start: "2026-10", end: "2027-10", color: PHASE_COLORS.Permisos },
      { fase: "Financiamiento", start: "2027-06", end: "2028-03", color: PHASE_COLORS.Financiamiento },
      { fase: "Construcción", start: "2028-04", end: "2029-01", color: PHASE_COLORS.Construcción },
      { fase: "Operación", start: "2029-02", end: "2030-12", color: PHASE_COLORS.Operación },
    ],
  },
];
